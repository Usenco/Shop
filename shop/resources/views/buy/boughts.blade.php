...
<script>
    ...
    let max_page =1;
    let token = $('#token').val();
    let link ='http://127.0.0.1:8000/api/boughts';
        ...
        page:i}, function(data){
            ...
            read_products_html+=
                ...
                <div class="product-item" style = "height:600px">
                  <a href="`+$('#url').val()+'/'+val[0].boughtproduct.id+`">
                  <img src="`+val[0].boughtproduct.mainimg+`" height="350px" alt="not found"></a>
                  <div class="down-content">
                    <a href="`+"#"+`"><h4 style = "margin-right:60px;height:40px;overflow: hidden;">`+val[0].boughtproduct.title+`</h4></a>
                    <h6>`+val[0].boughtproduct.price+`</h6>
                    <p style = "height:90px;overflow: hidden; text-overflow: ellipsis;">`+val[0].boughtproduct.description+`</p>
                    <ul class="stars">`;
            for (let index = 0; index < val[0].boughtproduct.mark; index++) {
            ...
            read_products_html+=
            `        </ul>
                    <span>Reviews(`+val[0].boughtproduct.reviews+`)</span>
                  </div>
                </div>
                </div>
                `;

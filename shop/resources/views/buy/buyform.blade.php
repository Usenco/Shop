...
@if ($whole_price != null)
  <input type="hidden" id = "whole_price" value = "{{$whole_price}}">
  <input type="hidden" id = "whole_num" value = "{{$whole_num}}">
@else
  <input type="hidden" id = "whole_price" value = "{{$price}}">
  <input type="hidden" id = "whole_num" value = "1">    
@endif
...
<div>
  <form action="{{asset('buyform')}}" method = "POST">
  ...
  <div id = "buycontainer">
    ...
    <div id = "rightbuycontainer">
      
       <div style = "display:flex;justify-content: center;flex-wrap:wrap;">
          <div id = "image">
            <img src="{{$mainimg}}" alt="cloth">
          </div>
          <div>
            <h3 style = "font-size:24px;font-weight:600;">{{$title_p}}</h3>
            <div id = "descrip">
            {{$description_p}}
          </div>
        </div>
       ...
       <div>
         ...
         <span style = "font-size:16px;">
          @isset($whole_num)
           При покупке от <b>{{$whole_num}}</b> едениц цена начисляеться как оптовая
          @endisset
         </span>
         <div style = "margin-top:10px;"></div>
         ...
         <div class = "price" style = "font-size:18px;">
           @isset($whole_price)
           <div style = "margin-right:10px;">Whole Price:</div>
           <div style = "color:red">{{$whole_price}}UAN</div>
           @endisset
         </div>
         <div style = "margin-top:10px;"></div>
         <div style = "display:flex;justify-content:space-between;font-size:18px;">
          <div style = "margin-right:10px;">Common Price:</div>
          <div><b><span id = "comprice">4000</span>UAN</b></div>
         </div>
